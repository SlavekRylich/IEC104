            ...
            try:
                ...
                if session.connection_state == 'CONNECTED':
                    ...
                    if actual_transmission_state == 'STOPPED':
                        ...
                        if self.round > 0:
                            # for 1,2,3,... round wait 0.8x t1 and
                            await asyncio.sleep(self.async_time_0_8xt1)
                        ...
                        if self.client_manager.flag_start_sequence:
                            ...
                            await self.client_manager.on_message_recv_or_timeout(session)

                            # update round, 1 round = 35 I-formats
                            self.round += 1
                    ...
                    if actual_transmission_state == 'RUNNING':
                        ...
                        for i in range(0, 35):
                            ...
                            await self.client_manager.send_frame(session, new_frame)
                            await asyncio.sleep(self.async_time/4)
